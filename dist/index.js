...
var decorateHeader = exports.decorateHeader = function decorateHeader(Header, _ref) {
  ...
  return function (_React$PureComponent) {
    ...
    (0, _createClass3.default)(_class, [{
      ...
      value: function componentWillUpdate(nextProps) {
        var statusIcon = nextProps.loading ? 'ellipsis-h' : 'check-circle';
        var headerProps = (0, _assign2.default)({ statusIcon: statusIcon }, nextProps);
        this.header = (0, _Header2.default)(nextProps);
      }
    }, {
      key: 'render',
      value: function render() {
        return React.createElement(Header, (0, _extends3.default)({}, this.props, { headerWidgets: this.header }));
      }
    }], [{
      key: 'displayName',
